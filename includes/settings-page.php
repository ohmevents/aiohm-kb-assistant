...
class AIOHM_KB_Settings_Page {
    ...
    public function sanitize_settings($input) {
        $sanitized = [];
        if (isset($input['personal_api_key'])) {
            $sanitized['personal_api_key'] = sanitize_text_field(trim($input['personal_api_key']));
        }
        ...
        if (isset($input['scan_schedule'])) {
            $sanitized['scan_schedule'] = sanitize_key($input['scan_schedule']);
        }
        return $sanitized;
    }
}