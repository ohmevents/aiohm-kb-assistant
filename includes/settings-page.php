 ...
 * Final version ensures all data is prepared for the scan page.
 */
...
class AIOHM_KB_Settings_Page {
    ...
    public function render_dashboard_page() { include AIOHM_KB_PLUGIN_DIR . 'templates/admin-dashboard.php'; }
    ...
    public function register_settings() { register_setting('aiohm_kb_settings', 'aiohm_kb_settings', array($this, 'sanitize_settings')); }
