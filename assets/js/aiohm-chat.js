jQuery(document).ready(function($) {
    ...
    function sendMessage() {
        ...
        performAjaxRequest('aiohm_private_assistant_chat', { // Corrected action name
            message: message,
    ...
    $('#new-project-btn').on('click', function() {
        ...
        if (projectName && projectName.trim() !== '') {
            performAjaxRequest('aiohm_create_project', { project_name: projectName.trim() }).done(function(response) { // Changed 'name' to 'project_name'
                if (response.success) {
    ...
    conversationList.on('click', '.aiohm-pa-list-item', function(e) {
        ...
        performAjaxRequest('aiohm_get_conversation_history', { conversation_id: currentConversationId }).done(function(response) { // Corrected action name
